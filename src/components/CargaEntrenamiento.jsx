...
function CargaEntrenamiento({ perfil }) {
  ...
  async function handleGuardarBloque() {
    if (!descripcion || !duracion || !categoriaId || !fecha) return
    setGuardando(true)
    ...
    <div className="p-6 md:p-10">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-sm mb-6" style={{ color: '#5B6B85' }}>
          Cargá los bloques del entrenamiento del día (duración y a qué jugadoras aplica), para calcular
          la carga real de cada una.
        </p>
        ...
        {!categoriaId && (
          <p className="text-sm" style={{ color: '#5B6B85' }}>
            Elegí una categoría para ver o cargar los bloques del día.
          </p>
        )}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {posicionesDisponibles.length === 0 && (
                      <p className="text-xs" style={{ color: '#5B6B85' }}>
                        No hay posiciones cargadas en esta categoría todavía.
                      </p>
                    )}
